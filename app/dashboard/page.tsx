...
export default function Dashboard() {
  ...
  // 1. VUTA SHEREHE ZOTE KUTOKA DATABASE (Kwa ulinzi wa Build ya Vercel)
  useEffect(() => {
  ...
  // LINK KUU YA VERCEL ILIYOWAKA LIVE HEWANI
  const BASE_PRODUCTION_URL = "https://mialiko-system-sjwp-git-main-mtavanguanord-9967s-projects.vercel.app";

  // MTAMBO WA KUTUMA MWALIKO WHATSAPP
  const sendWhatsAppMessage = (guest: Guest) => {
    const invitationLink = `${BASE_PRODUCTION_URL}/invitation/${guest.id}`;
